...
* Version: 0.9.9
  - [GitHub Release](https://github.com/sane-fmt/sane-fmt/releases/tag/0.9.9)
  - [Deno Page](https://deno.land/x/sane_fmt@0.9.9)
...
#### [Main CLI](https://deno.land/x/sane_fmt@0.9.9/main.js)
...
deno install \
  ...
  --allow-env \
  --name=sane-fmt \
  https://deno.land/x/sane_fmt@0.9.9/main.js
```
...
#### [Stdio CLI](https://deno.land/x/sane_fmt@0.9.9/stdio.js)
...
deno install \
  --unstable \
  --name=sane-fmt-stdio \
  https://deno.land/x/sane_fmt@0.9.9/stdio.js
```
...
* [/x/sane_fmt](https://deno.land/x/sane_fmt@0.9.9/index.ts)
* [API Reference](https://doc.deno.land/https/deno.land//x/sane_fmt@0.9.9/index.ts)

#### Example: Format a file

```javascript
import Context from 'https://deno.land/std@0.92.0/wasi/snapshot_preview1.ts'
import { u8v } from 'https://deno.land/x/sane_fmt@0.9.9/index.ts'
